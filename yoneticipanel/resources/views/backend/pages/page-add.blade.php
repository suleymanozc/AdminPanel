...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{route('page-add-post')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input id="coverImage" name="page_image" type="file" class="custom-file-input" id="customFile">
